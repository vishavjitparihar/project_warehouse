...
import '../Update/WarehouseUpdate.css';
import { useParams } from "react-router-dom";

export const WarehouseUpdate = ({setWarehouseList}) => {
    ...
    const handleSubmit = async (event) => {
        ...
        try {
            const res = await axios.put(`http://localhost:9000/warehouse/${id}`, {
            ...
            <div className="wrapper wrapper--w780">
                <div className="card card-3">
                    ...
                    <div className="card-body">
                        <h2 className="title">Update an Existing Warehouse</h2>
                        ...
                        <form onSubmit={handleSubmit}>
                            ...
                            <div className="input-group">
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.quantity1} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, quantity1: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />

                                    <label className="label">Maximum Capacity</label>
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.max1} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, max1: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                            ...
                            <div className="input-group">
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.quantity2} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, quantity2: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.max2} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, max2: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                            ...
                            <div className="input-group">
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.quantity3} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, quantity3: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.max3} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, max3: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                            ...
                            <div className="input-group">
                                    <input 
                                        ...
                                        placeholder="Object ID for Product 4"
                                    />
                            </div>
                            ...
                            <div className="input-group">
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.quantity4} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, quantity4: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.max4} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, max4: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                            ...
                            <div className="input-group">
                                    <input 
                                        ...
                                        placeholder="Object ID for Product 5"
                                    />
                            </div>
                            ...
                            <div className="input-group">
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.quantity5} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, quantity5: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
                                    ...
                                    <input 
                                        className="input--style-3" 
                                        value={warehouseData.max5} 
                                        //using event value we are updating the model
                                        onChange={e => setWarehouseData({...warehouseData, max5: e.target.value})}
                                        placeholder="current quantity = existing + new"
                                    />
